...
export default function SNS둘러보기(): JSX.Element {
  ...
  return (
    <Container.Scroll>
      <TextPage.CommonText>
        {`dono.LUNA의 사용 만으로도 건강한 생리 활동이 가능합니다만, 보다 적극적인 자궁의 건강을 위하여 식음료, 옷, 생활 그리고 심리적, 정서적 안녕이 중요합니다. 

3년이 넘는 개발과 시험과정에서 dono. LUNA의 기술진들은 생명이 잉태되는 자궁의 중요함과  신비로움에 대하여 경탄과 찬사를 끊이질 않았습니다.  

즉, 자궁의 건강은 비단 생리진통의 경감을 위하여 챙기는 것이 아닙니다. 이는 곧 폐경의 지연과 더불어 피부미용에도 깊은 연관이 있을뿐더러, 더 나아가 인류의 진화가 이어지는 곳 이기도 합니다.

dono.LUNA 공식 블로그와 다양한 SNS채널에서는 자궁의 건강을 위한 다양한 정보를 SNS 채널을 통하여 지속적으로 업데이트 할 것입니다. 

dono.LUNA와 함께 심리적, 정신적 그리고 사회적 안녕을 맞이하면 평온하고 건강하게 삶의 질이 향상되시리라 기대 해 봅니다.
